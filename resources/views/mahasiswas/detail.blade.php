...
<li class="list-group-item"><img width="100px" src="{{ $Mahasiswa->foto==''? asset('images/default.png'): asset('storage/'.$Mahasiswa->foto) }}" class="rounded mx-auto d-block" alt=""></li>
